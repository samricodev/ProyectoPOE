 ...
 * @author ramos
 */
public class frmCRegistrar extends javax.swing.JFrame {

    /**
     * Creates new form frmCompras
     */
    public frmCRegistrar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmCRegistrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmCRegistrar().setVisible(true);
            }
        });
    }
